...
详细内容见：[IPFS官方文档：Content addressing and CIDs][21]{.broken_link}

在线的CID查看器：[CID Inspector][22]{.broken_link}
...
具体见：[IPFS文档：Gateway][23]{.broken_link}
...
具体见：[IPFS文档：IPNS][24]{.broken_link}
...
访问：<http://localhost:8080/ipfs/QmdoJ8BiuN8H7K68hJhk8ZrkFXjU8T9Wypi9xAyAzt2zoj>{.broken_link}
...
然后任何人都可以用 \`/ipfs/ipfs.lgf.im\` 来找到我的网站了，访问<http://localhost:8080/ipns/ipfs.lgf.im>{.broken_link}

![DNSLink Web][30] 

详细文档见：[IPFS文档：DNSLink][31]{.broken_link}
...
具体见：[IPFS文档：Merkle][32]{.broken_link}

### 分布式散列表DHT

具体见：[IPFS文档：DHT][33]{.broken_link}
...
## 参考资料
  ...
  * [IPFS官网][2]{.broken_link}
  * [IPFS文档][36]{.broken_link}
  * [IPFS博客][37]{.broken_link}
  * [维基百科：星际文件系统][38]{.broken_link}
  * [将博客部署到星际文件系统（IPFS）][39]

## 资源分享

  * 机械工业出版社294G原版PDF：[/ipfs/QmZYDnPgTRs1MmBx9TPrADFV1K85sPSqLJhAShWayubu9c][40]{.broken_link}

 [1]: https://lgf.im/posts/p2p/ipfs/
 [2]: https://ipfs.io/
 [3]: https://github.com/ipfs
 [4]: compare/ipfs-illustration-http.svg
 [5]: compare/ipfs-illustration-history.svg
 [6]: compare/ipfs-illustration-centralized.svg
 [7]: compare/ipfs-illustration-network.svg
 [8]: usefull/usefull_1.png
 [9]: usefull/usefull_2.png
 [10]: work/work_1.png
 [11]: work/work_2.png
 [12]: work/work_3.png
 [13]: work/work_4.png
 [14]: work/one-ipfs-node-only.png
 [15]: work/work_5.png
 [16]: tutorial/ipfs_env.png
 [17]: tutorial/ipfs_init.png
 [18]: tutorial/ipfs_get.png
 [19]: tutorial/ipfs_ls.png
 [20]: tutorial/ipfs_add.png
 [21]: https://docs.ipfs.io/concepts/content-addressing/
 [22]: https://cid.ipfs.io/
 [23]: https://docs.ipfs.io/concepts/ipfs-gateway/
 [24]: https://docs.ipfs.io/concepts/ipns/
 [25]: web/ipfs_local_web.png
 [26]: web/local_error.png
 [27]: web/ipfs_web.png
 [28]: web/ipns_web.png
 [29]: web/dnslink.png
 [30]: web/ipfs_dnslink_web.png
 [31]: https://docs.ipfs.io/concepts/dnslink/#publish-using-a-subdomain
 [32]: https://docs.ipfs.io/concepts/merkle-dag/
 [33]: https://docs.ipfs.io/concepts/dht/
 [34]: ipfs-applications-diagram.png
 [35]: filecone.png
 [36]: https://docs.ipfs.io/
 [37]: https://blog.ipfs.io/
 [38]: https://zh.wikipedia.org/wiki/%E6%98%9F%E9%99%85%E6%96%87%E4%BB%B6%E7%B3%BB%E7%BB%9F
 [39]: https://io-oi.me/tech/host-your-blog-on-ipfs/
 [40]: https://ipfs.io/ipfs/QmZYDnPgTRs1MmBx9TPrADFV1K85sPSqLJhAShWayubu9c/
